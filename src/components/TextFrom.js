...
export default function TextFrom(props) {
    ...
    let slow_read_speed = 0.008 * text.split(' ').length;
    let medium_read_speed = 0.0047 * text.split(' ').length;
    let fast_read_speed = 0.003 * text.split(' ').length;
    ...
    return (
        <>
            <div className='container'>
                ...
                <button className="btn btn-primary mx-3 my-2" onClick={handleCopy}>Copy Text to ClipBoard</button>
                <button className="btn btn-primary mx-3 my-2" onClick={handleExtraSpaces}>Remove Extra Spaces</button>
                <button className="btn btn-primary mx-3 my-2" onClick={() => setText(capitalizeWords(text))}>Capitalize</button>
            ...
            <div className="container" style={{marginBottom:'20px'}}>
                ...
                <p className={` ${TextColor}`}>{text.split(' ').length} words,{text.length} characters </p>
